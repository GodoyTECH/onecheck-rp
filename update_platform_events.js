...
// Replace carregarMissoes function and tab logic
const newMissoesLogic = `
...
const eventListeners = `
    ...
    document.getElementById('btnSalvarEventoConfirmado')?.addEventListener('click', async () => {
        ...
        try {
            ...
            GRK.toast('Evento cadastrado e push notifications agendados!', 'success');
...
// Inject eventListeners at the end of inicializarEventListeners()
js = js.replace(/function mostrarLogin\(\)/, eventListeners + '\nfunction mostrarLogin()');

// Remove old mission create listener
js = js.replace(/\/\/ Criar miss.*?\n[\s\S]*?missionCreateBtn'\)\?\.addEventListener\('click'[\s\S]*?}\);/g, '');
